'use strict';
{
  ...
  function prepareList(){
    word=[
      ...
      ["Presentation","Document","Theme","Slide","Style","Fill","Border","Opacity","Title","Caption"],
      ...
      ["Polygon","Triangle","Quadrilateral","Parallelogram","Rectangle","Rhombus","Square","Trapezoid","Pentagon","Hexagon","Octagon","Circle","Radius","Diameter","Circumference","Area","Pi","Solid","Cube","Spere","Cylinder","Cone","Pyramid"],
    ...
    meaning=[
      ...
      ["A speech with multimedia support. There is software specifically designed for giving presentations, such as Microsoft Power Point or Apple Keynote.","A computer file.","The overall format of a presentaion.","One page of a presentation.","The color, size, etc., of a shape. The way it looks.","The color of a shape (expect for the edge).","The color and type of the edge of a shape.","The degree to which we can see through a shape.","The name of a shape.","An explanation of a shape."],
      ...
      ["Information that we study (e.g., for research).","The branch of mathematics that analyzes numerical data.","How far a data set spans, the highest element minus the lowest.","The most frequently occuring element of a data set.","All the elements of a data set, divided by the number of elements.","The exact middle of the data set, so that mode is &ge; 50% of the elements, AND &le; 50% of the elements.","An amount that can change.","A graph using pictures to show amounts.","A graph using bars to show amounts.","Part of a graph that shows the meanings of the symbols.","Part of a graph that shows the amounts.","","A diagram made of overlapping circles, showing the relationship between two or more variables.","A graph using lines to show amounts. It's good for showing change over time.","A graph that shows two variables on two axes.","The horizontal (lying flat) line of a line graph.","The vertical (standing up) line of a line graph.","Coordinates showing position on a line graph."]
    ];
    examples=[
      ...
      ["The Internet is a kind of network.","The WWW makes information on the Internet searchable.","CIST Website","CIST home page, CIST faculty page, etc.","$html","→ http://","Firefox, Chrome, Safari","Google, Bing","https://www.chitose.ac.jp",'<a href="https://www.chitose.ac.jp"><img src="img/click_here.jpeg"></a>','<a href="https://www.chitose.ac.jp">Click here</a>'],
      ["","","","","","","","","",""],
      ...
      ["-1, -2, -3, etc.",'The number "-1" can be read "negative one".','The number "-1" can be read "minus one"','"2>1", "1<2", "x&ge;1", "y&le;1", "x≠1", etc.',">","<","&ge;","&le;","≠","≠"],
      ["2^5, 3^4, 4^3, 5^2, etc.",'"In the exponential term 2^5, the "5" is the exponent."','In the exponential term 2^5, the "2" is the base number.','The exponential term 5^2 is read, "five squared".','The exponential term 5^2 can also be read, "five to the second power".','The exponential term 4^3 is read, "four cubed".','The exponential term 4^3 can also be read, "four to the third power".','The exponential term 3^4 is read, "three to the fourth power".',"4 is the square of 2.","2 is the square root of 4.","√5","√",'In the radical expression √5, the "5" is the radicand.','The radical expression √5 is read, "the square root of five".',"1, 4, 9, 16, 25, etc."],
      ["","∞","","•","$line","$ray","$segment","",'In the notation "90°" the "°" is read "degrees".',"$right_angle","$acute","$obtuse","$parallel","$perpendicular","≡"],
      ["triangle, quadrilateral, parallelogram, rectangle, rhombus, etc.","$triangle","$quadrilateral","$parallelogram","$rectangle","$rhombus","$square","%trapezoid","$pentagon","$hexagon","$octagon","$circle","$radius","$diameter","$circumference","$area","&pi;","cube, sphere, cylinder, cone, pyramid, etc.","$cube","$spere","$cylinder","$cone","$pyramid"],
      ["","","In the data set 2, 3, 4; the range is 2 (= 4-2).","In the data set 2, 3, 4, 4; the mode is 4.","In the data set 2, 3, 4; the mean is 3 (= (2+3+4)/3)","In the data set 2, 3, 9; the median is 3.","","$pictograph","$bar_graph","$key","$scale","$pie_chart","$venn_diagram","$line_graph","$scatter_plot","","",'(x,y) e.g., "2,4"']
    ];
  }
}