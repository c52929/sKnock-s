...

{
	...
	function reset(){
		if(mode=='d'){
			words=['匂ふ','移ろふ','往ぬ・去ぬ','遊ぶ','<ruby><rb>愛</rb><rt>め</rt></ruby>づ','慣らふ・馴らふ','かしづく','頼む','守る','聞こゆ','おこす','<ruby><rb>設</rb><rt>まう</rt></ruby>く','<ruby><rb>答</rb><rt>いら</rt></ruby>ふ','渡る','具す','<ruby><rb>訪</rb><rt>とぶら</rt></ruby>ふ・<ruby><rb>弔</rb><rt>とぶら</rt></ruby>ふ','物す','わななく','わづらふ','惑ふ','<ruby><rb>被</rb><rt>かづ</rt></ruby>く','失す','行ふ'];
