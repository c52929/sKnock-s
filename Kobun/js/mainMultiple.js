...

{
	...
	function reset(){
		...
		// 		break;
		// }
		words=["宣:のたま;ふ・宣:のたま;はす","仰:おほ;す","聞:き;こし召:め;す","御:ご;覧:らん;ず","申:まう;す","聞:き;こゆ・聞:き;こえさす","おはす・おはします","思:おぼ;す・思:おぼ;し召:め;す","賜:たま;ふ・給:たま;ふ(ハ行四段)","賜:たま;ふ・給:たま;ふ(ハ行下二段)"];
		meanings=["おっしゃる","おっしゃる","お聞きになる/召し上がる","ご覧になる","申し上げる/(お)～申し上げる","申し上げる/差し上げる/(お)～申し上げる","いらっしゃる/～ていらっしゃる","お思いになる","お与えになる/お～になる","～ております"];
		words.push("賜:たま;はす","賜:たま;はる・給:たま;はる","承:うけたまは;る","奉:たてまつ;る","侍:はべ;り","候:さぶら;ふ","召:め;す","詣:まう;づ","参:まゐ;る","参:まゐ;らす");
		meanings.push("お与えになる","いただく","お受けする/お聞きする","差し上げる/(お)～申し上げる/お召しになる","お仕えする/あります/～(ござい)ます","お仕えする/あります/～(ござい)ます","お呼び寄せになる/召し上がる/お召しになる/お乗りになる","参上する/参詣する","参上する/差し上げる/し申し上げる/召し上がる","差し上げる/(お)～申し上げる");
		words.push("罷:まか;る","罷:まか;づ","遣:つか;はす","遊:あそ;ばす","仕:つか;うまつる","大:おお;殿:との;籠:ごも;る","しろしめす","行:ぎやう;幸:がう;・行:ぎやう;啓:けい;・御:ご;幸:かう;","奏:そう;す","啓:けい;す");
		meanings.push("退出する/参ります/～申す","退出する/出かけます","おやりになる/お与えになる/贈る","演奏をなさる/～(を)なさる","お仕え申し上げる/し申し上げる/(お)～申し上げる","おやすみになる","ご存じである/お治めになる","天皇のお出かけ/皇后・皇太子などのお出かけ/上皇・法皇・女院のお出かけ","(天皇・上皇に)申し上げる","(皇后・皇太子に)申し上げる");
		rew=[];
		rem=[];
		qNum=[0,words.length,''];
